        ...
        <div className='mt-8 md:mt-12 lg:mt-25 max-w-7xl mx-auto'>
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 justify-items-center mt-10">
                {items.slice(0, 3).map((item) => (
                    <div key={item._id} className="card w-full max-w-sm bg-[#F3F3F3] shadow-md rounded-xl transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
