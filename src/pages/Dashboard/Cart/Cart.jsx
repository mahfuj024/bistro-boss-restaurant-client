...
function Cart() {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <h1 className="cinzel-font text-2xl md:text-3xl lg:text-4xl font-bold text-center my-3 md:my-3 lg:my-4">My Cart</h1>
            ...
            <div className="bg-white p-1 sm:p-4 md:p-6 lg:p-9 rounded-sm mt-4 md:mt-5 lg:mt-7">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mb-6 pt-2 md:pt-0">
                    ...
                    <Link
                        to={cart.length > 0 ? "/dashboard/payment" : "#"} // empty হলে # (no navigation)
                        onClick={(e) => {
                            if (cart.length === 0) e.preventDefault(); // prevent link click if cart empty
                        }}
                    >
                        <button
